            ...
            <div class="card-body p-5 text-center">
              ...
              <form action="./api/reg_user.php" method="post">
                ...
                <div class="mb-md-5 mt-md-4 pb-5">
                  ...
                  <h2 class="fw-bold mb-2 text-uppercase">教師註冊</h2>
                  <p class="text-white-50 mb-5">輸入帳號密碼來註冊!</p>
                  ...
                  <div class="form-outline form-white mb-4">
                    ...
                    <label class="form-label" for="typePasswordX">信箱</label>
                  </div>

                  <div class="form-outline form-white mb-4">
                    <input type="text" id="typeNameX" class="form-control form-control-lg" name="name" />
                    <label class="form-label" for="typePasswordX">姓名</label>
                  </div>



                  <input class="btn btn-outline-light btn-lg px-5" type="reset" value="重置"></input>
                  <input class="btn btn-outline-light btn-lg px-5" type="submit" value="註冊"></input>
              </form>
